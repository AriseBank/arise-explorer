    ...
    this.getStatistics = function (e, error, success) {
        ...
        if (!config.marketWatcher.enabled) {
            var statistics = {
                ...
                ariseVolume : Number(0).toFixed(8),
                numTrades : 0
            };
        ...
        function (err, results) {
            if (err) {
                ...
                var statistics = {
                    ...
                    ariseVolume : _.reduce(results[0], function (memo, t) { return (memo + parseFloat(t.ariseVolume)); }, 0.0).toFixed(8),
                ...
                statistics = {
                    ...
                    ariseVolume : statistics.ariseVolume,
