Feature: Footer
  Scenario: should contain links to Arise website, forum, BBT thread, reddit twitter, Explorer Github
    Given I'm on page "/"
    Then I should see "website link" element that links to "https://arise.io/"
    Then I should see "forum link" element that links to "https://forum.arise.io/"
    Then I should see "btt thread link" element that links to "https://bitcointalk.org/index.php?topic=1346646"
    Then I should see "reddit link" element that links to "https://www.reddit.com/r/Arise/"
    Then I should see "twitter link" element that links to "https://twitter.com/AriseHQ"
    Then I should see "github link" element that links to "https://github.com/AriseHQ/arise-explorer"
  ...
  Scenario: allows to show all 8 decimal places
    ...
    And I should see table "latest transactions" with 20 rows starting with:
      | Id                   | Timestamp                 | Sender      | Recipient             | Amount (ACO) | Fee (ACO) |
      |----------------------|---------------------------|-------------|-----------------------|--------------|-----------|
