...
// ARISE node
config.arise.host = '127.0.0.1';
config.arise.port = 9012; // Devnet: 4000, Testnet: 7000, Mainnet: 9012
...
config.exchangeRates.exchanges.ACO.BTC = 'poloniex'; // ACO/BTC pair, supported: poloniex
config.exchangeRates.exchanges.ACO.CNY = 'jubi';     // ACO/CNY pair, supported: jubi, bitbays
