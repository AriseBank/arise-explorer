    ...
    describe('GET /api/getPriceTicker', function() {
        it('should be ok', function(done) {
            getPriceTicker(function(err, res) {
                ...
                node.expect(res.body).to.have.deep.property('tickers.ACO.BTC').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.ACO.EUR').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.ACO.USD').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.ACO.CNY').to.be.a.number;
